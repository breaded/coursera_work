...
// $app->post('/empresa', 'empresa'); /* User empresa  */
// $app->post('/empresaUpdate', 'empresadUpdate'); /* User empresa  */
// $app->post('/empresaDelete', 'empresaDelete'); /* User empresa  */
...
function feedUpdate(){
    ...
    try {
        ...
        if($systemToken == $token){
            ...
            $feedData = '';
            $db = getDB();
            $sql = "INSERT INTO feed ( feed,  user_id_fk) VALUES (:feed,:user_id)";
            $stmt = $db->prepare($sql);
...
//             $sql = "SELECT * FROM empresa  ORDER BY empresa_id DESC LIMIT 15";
//             $stmt = $db->prepare($sql);
//             $stmt->bindParam("user_id", $user_id, PDO::PARAM_INT);
...
//             if ($empresaData)
//                 echo '{"empresaData": ' . json_encode($empresaData) . '}';
//             else
//                 echo '{"empresaData": ""}';
//         } else {
//             echo '{"error":{"text":"No access"}}';
...
//             $db = getDB();
//             if ($dateCreated) {
//                 $sql = "SELECT * FROM empresa WHERE user_id_fk=:user_id AND created < :dateCreated ORDER BY empresa_id DESC LIMIT 5";
               
//                /*************Ended here today 6/12/2018 *******/
//                 $stmt = $db->prepare($sql);
//                 $stmt->bindParam("user_id", $user_id, PDO::PARAM_INT);
//                 $stmt->bindParam("dateCreated", $dateCreated, PDO::PARAM_STR);
//             } else {
//                 $sql = "SELECT * FROM empresa WHERE user_id_fk=:user_id ORDER BY feed_id DESC LIMIT 5";
//                 $stmt = $db->prepare($sql);
//                 $stmt->bindParam("user_id", $user_id, PDO::PARAM_INT);
//             }
//             $stmt->execute();
//             $empresaData = $stmt->fetchAll(PDO::FETCH_OBJ);
...
//             $empresaData = '';
//             $db = getDB();
//             $sql = "INSERT INTO empresa ( empresa,  user_id_fk) VALUES (:empresa,:user_id)";
//             $stmt = $db->prepare($sql);
...
//             $sql1 = "SELECT * FROM empresa WHERE user_id_fk=:user_id ORDER BY empresa_id DESC LIMIT 1";
//             $stmt1 = $db->prepare($sql1);
//             $stmt1->bindParam("user_id", $user_id, PDO::PARAM_INT);
//             $stmt1->execute();
//             $feedData = $stmt1->fetch(PDO::FETCH_OBJ);
...
//             $empresaData = '';
//             $db = getDB();
//             $sql = "Delete FROM empresa WHERE user_id_fk=:user_id AND empresa_id=:empresa_id";
//             $stmt = $db->prepare($sql);
//             $stmt->bindParam("user_id", $user_id, PDO::PARAM_INT);
